...
<div class="subtitle"><h3>Select a Game</h3></div>

<div class="container">
    <?php foreach ($games as $game): ?>
        <div class="game-card">
        <img src="/dbms_project/admin/admin_manage/uploads/<?php echo htmlspecialchars($game['game_image']); ?>" alt="<?php echo htmlspecialchars($game['title']); ?>">

...
if ($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET["query"], $_GET["module"])) {
    ...
    $sql = match ($module) {
        ...
        "ranks" => "SELECT * FROM ranks WHERE rank_name LIKE ?", // Added rank search query
        default => ""
    };
...
<div class="container">
    ...
    <div class="options">
        <form action="user_management.php" method="POST"><button class="option-button" type="submit">Admin-Users</button></form>
